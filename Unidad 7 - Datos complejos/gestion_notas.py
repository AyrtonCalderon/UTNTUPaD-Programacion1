...
for legajo,nombre in alumnos.items():
    print(f"{nombre}")
    suma_promedio_materia = 0 # Para acumular las notas del alumno

#Por cada alumno, recorremos la lista de materias
    for mat in materias:
        nombre_materias = mat[0]
        print(f"Ingrese las notas para {nombre_materias}: ")
    ...
    # Pedir Nota 2 con validación (0 al 10)
        ...
        print(f"Nota Final en {nombre_materias}: {promedio_materia}")
